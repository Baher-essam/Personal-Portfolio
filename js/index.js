...
const LiquidButton = class LiquidButton {
  constructor(optionsParam) {
    ...
    this.text = options.text || "Download CV";
    this.canvas = options.canvas || document.createElement("canvas");
    this.context = this.canvas.getContext("2d");
    this.wrapperElement = options.wrapperElement || document.getElementById('canvas');
  ...
  draw() {
    ...
    this.context.font =
      "100 " + (this.height - this.padding * 2) + "px sans-serif";
